  ...
  <div>
    <ClientOnly>
      ...
      <vxe-button @click="loadData(30000)">加载3w行</vxe-button>
        ...
        >
          <!-- <vxe-column key="drag" resizable title=" " drag-sort width="32px"> </vxe-column> -->
          <vxe-column field="col0" fixed="left" drag-sort title="列0" width="160"></vxe-column>
          <vxe-column field="col1" fixed="left" title="列1" width="100"></vxe-column>
          <vxe-column field="col2" fixed="left" title="列2" width="160"></vxe-column>
          <vxe-column field="col3" fixed="left" title="列3" width="200"></vxe-column>
