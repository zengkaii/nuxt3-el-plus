...
const v =
  ({ finisher: r, descriptor: t }) =>
    (e, i) => {
      let n
      if (i === void 0) {
        const l = (n = e.originalKey) !== null && n !== void 0 ? n : e.key
        let h = t != null ? { kind: 'method', placement: 'prototype', key: l, descriptor: t(e.key) } : { ...e, key: l }
        return (
          r != null &&
  ...
  return v({
    descriptor: (e) => {
      const i = {
        get() {
          let n, l
          return (l = (n = this.renderRoot) === null || n === void 0 ? void 0 : n.querySelector(r)) !== null &&
            l !== void 0
            ? l
            : null
        },
      ...
      if (t) {
        ...
        i.get = function () {
          ...
          return (
            this[n] === void 0 &&
              (this[n] =
                (h = (l = this.renderRoot) === null || l === void 0 ? void 0 : l.querySelector(r)) !== null &&
                h !== void 0
                  ? h
                  : null),
            this[n]
...
;((L = window.HTMLSlotElement) === null || L === void 0 ? void 0 : L.prototype.assignedElements) != null
  ...
  : (r, t) => r.assignedNodes(t).filter((e) => e.nodeType === Node.ELEMENT_NODE)
const I = {
...
const a = class extends b {
  ...
  _handleSeekChange(t) {
    ...
    try {
      ...
      const n = (i / 100) * this._dotLottieCommonPlayer.totalFrames
      this.seek(n)
    } catch {
  ...
  _initListeners() {
    const t = this._dotLottieCommonPlayer
    if (t === void 0) {
    ...
    ;(this._unsubscribeListeners = t.state.subscribe((e$1, i) => {
      ;(this._seeker = e$1.seeker),
        this.requestUpdate(),
        i.currentState !== e$1.currentState && this.dispatchEvent(new CustomEvent(e$1.currentState)),
        this.dispatchEvent(new CustomEvent(e.Frame, { detail: { frame: e$1.frame, seeker: e$1.seeker } })),
        this.dispatchEvent(
          new CustomEvent(e.VisibilityChange, { detail: { visibilityPercentage: e$1.visibilityPercentage } })
        )
    })),
  ...
  async load(t, e, i) {
    ...
    this._dotLottieCommonPlayer && this._dotLottieCommonPlayer.destroy(),
      (this._dotLottieCommonPlayer = new j(t, this.container, {
        rendererSettings:
          e != null ? e : { scaleMode: 'noScale', clearCanvas: !0, progressiveLoad: !0, hideOnTransparent: !0 },
  ...
  animationCount() {
    ...
    return (
      (this._dotLottieCommonPlayer &&
        ((t = this._dotLottieCommonPlayer.getManifest()) == null ? void 0 : t.animations.length)) ||
      0
    )
  }
  ...
  animations() {
    ...
    const t = this._dotLottieCommonPlayer.getManifest()
    return (t == null ? void 0 : t.animations.map((e) => e.id)) || []
  }

  currentAnimation() {
    return !this._dotLottieCommonPlayer || !this._dotLottieCommonPlayer.currentAnimationId
      ? ''
  ...
  getVersions() {
    return { lottieWebVersion: j.getLottieWebVersion(), dotLottiePlayerVersion: `${I.version}` }
  }
      ...
      'IntersectionObserver' in window &&
        ((this._io = new IntersectionObserver((e) => {
          ...
          e[0] !== void 0 && e[0].isIntersecting
            ? ((i = this._dotLottieCommonPlayer) == null ? void 0 : i.currentState) === f.Frozen && this.play()
            : ((n = this._dotLottieCommonPlayer) == null ? void 0 : n.currentState) === f.Playing && this._freeze()
        })),
  ...
  disconnectedCallback() {
    ...
    this._io && (this._io.disconnect(), (this._io = void 0)),
      ...
      window && window.removeEventListener('click', (i) => this._clickOutListener(i))
  }
  ...
  _clickOutListener(t) {
    !t
      .composedPath()
      .some((i) =>
        i instanceof HTMLElement ? i.classList.contains('popover') || i.id === 'lottie-animation-options' : !1
      ) &&
      this._popoverIsOpen &&
  ...
  renderControls() {
    let i, n, l, h, b
    const t = ((i = this._dotLottieCommonPlayer) == null ? void 0 : i.currentState) === f.Playing
    const e = ((n = this._dotLottieCommonPlayer) == null ? void 0 : n.currentState) === f.Paused
    return a$3`
                ...
                this._styleTabIsOpen
                  ? a$3`<div class="option-title-themes-row">
                      ...
                      >
                        ...
                        ${
                          ((b = this._dotLottieCommonPlayer) == null ? void 0 : b.defaultTheme) === ''
                            ? a$3``
                            : a$3`
                              <button
                                class="reset-btn"
  ...
  render() {
    ...
    const e = this.controls ? 'animation controls' : 'animation'
    return a$3`
